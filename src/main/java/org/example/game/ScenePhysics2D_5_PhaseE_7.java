...
public class ScenePhysics2D_5_PhaseE_7 extends ApplicationScreen {
    ...
    protected void refresh() {
        ...
        if (InputMouse.isButtonClicked(InputMouse.Button.LEFT)) {
            ...
            camera.lens.unproject(screen);
            world.createBodyPolygon(null, Physics2DBody.MotionType.NEWTONIAN,
                    screen.x,screen.y,0,
                    0f,0f,0,
                    1, 1, 1, false, 1,

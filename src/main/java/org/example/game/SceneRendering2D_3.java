...
public class SceneRendering2D_3 extends WindowScreen {
    ...
    protected void refresh() {
        ...
        float vf = (25f + 256f) / 512;
        renderer2D.pushTexture(texture0, new Color(1,1,1,1f), ui,vi,uf,vf,0,0,256,256,256,256,0,0,0, 1, 1,null,null);

        float ui2 = 331f / 512;
        float vi2 = 25f / 512;
        float uf2 = (331 + 126f) / 512f;
        float vf2 = (25f + 126) / 512;
        renderer2D.pushTexture(texture0, new Color(1,1,1,1f), ui2,vi2,uf2,vf2,207,236,126,126,400,400,0,0,0,0,0,null,null);

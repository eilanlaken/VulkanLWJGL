...
public final class Physics2DWorldCollision_better {

    private Physics2DWorldCollision_better() {}
    ...
    private static final class Projection implements Comparable<Projection> {
        ...
        @Override
        public int compareTo(@NotNull Physics2DWorldCollision_better.Projection other) {

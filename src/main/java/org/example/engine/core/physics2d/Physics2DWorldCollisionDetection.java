...
// https://github.com/RandyGaul/ImpulseEngine/tree/master
...
public final class Physics2DWorldCollisionDetection {
    ...
    public static boolean collide(final Shape2D a, final Shape2D b, Physics2DWorldCollisionManifold manifold) {
        a.update();
        b.update();

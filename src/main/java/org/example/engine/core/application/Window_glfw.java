 ...
 */
public class Window_glfw implements Resource {
    ...
    public Window_glfw(String title, int width, int height, int targetFps, boolean enableVSync, boolean allowResize) {
        this.title = title;
        this.width = width;
        this.height = height;

...
public class CollectionsArrayShort {
    ...
    public CollectionsArrayShort() {
        this(true, 16);
    }

    /** Creates an ordered array with the specified capacity. */
    public CollectionsArrayShort(int capacity) {
        this(true, capacity);
    }
    ...
    public CollectionsArrayShort(boolean ordered, int capacity) {
     ...
     * grown. */
    public CollectionsArrayShort(CollectionsArrayShort array) {
    ...
    public CollectionsArrayShort(short[] array) {
     ...
     * @param ordered If false, methods that remove elements may change the order of other elements in the array, which avoids a
     *           memory copy. */
    public CollectionsArrayShort(boolean ordered, short[] array, int startIndex, int count) {
        this(ordered, count);
        size = count;
    ...
    public void addAll (CollectionsArrayShort array) {
        addAll(array.items, 0, array.size);
    }

    public void addAll (CollectionsArrayShort array, int offset, int length) {
    ...
    public boolean removeAll (CollectionsArrayShort array) {
        int size = this.size;
        int startSize = size;
        short[] items = this.items;
    ...
    public boolean equals (Object object) {
        ...
        if (!(object instanceof CollectionsArrayShort)) return false;
        CollectionsArrayShort array = (CollectionsArrayShort)object;
    ...
    static public CollectionsArrayShort with (short... array) {
        return new CollectionsArrayShort(array);
    }

...
public class CollectionsArrayLong {

    public long[] items;
    public int size;
    public boolean ordered;

    public CollectionsArrayLong() {
        this(true, 16);
    }

    public CollectionsArrayLong(int capacity) {
        this(true, capacity);
    }

    public CollectionsArrayLong(boolean ordered, int capacity) {
    ...
    public boolean equals (Object object) {
        ...
        if (!(object instanceof CollectionsArrayLong)) return false;
        CollectionsArrayLong array = (CollectionsArrayLong) object;

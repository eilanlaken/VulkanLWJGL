...
public class CollectionsMapObjectInt<K> implements Iterable<CollectionsMapObjectInt.Entry<K>> {
    ...
    public CollectionsMapObjectInt() {
        this(51, 0.8f);
    }

    /** Creates a new map with a load factor of 0.8.
     * @param initialCapacity The backing array size is initialCapacity / loadFactor, increased to the next power of two. */
    public CollectionsMapObjectInt(int initialCapacity) {
     ...
     * @param initialCapacity The backing array size is initialCapacity / loadFactor, increased to the next power of two. */
    public CollectionsMapObjectInt(int initialCapacity, float loadFactor) {
    ...
    public CollectionsMapObjectInt(CollectionsMapObjectInt<? extends K> map) {
    ...
    public void putAll(CollectionsMapObjectInt<? extends K> map) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof CollectionsMapObjectInt)) return false;
        CollectionsMapObjectInt other = (CollectionsMapObjectInt)obj;
    ...
    private static class MapIterator<K> {
        ...
        final CollectionsMapObjectInt<K> map;
        int nextIndex, currentIndex;
        boolean valid = true;

        public MapIterator(CollectionsMapObjectInt<K> map) {
            this.map = map;
            reset();
        }
    ...
    static public class Entries<K> extends MapIterator<K> implements Iterable<Entry<K>>, Iterator<Entry<K>> {
        ...
        public Entries(CollectionsMapObjectInt<K> map) {
            super(map);
        }
    ...
    static public class Values extends MapIterator<Object> {
        public Values (CollectionsMapObjectInt<?> map) {
            super((CollectionsMapObjectInt<Object>)map);
        }
    ...
    public static class Keys<K> extends MapIterator<K> implements Iterable<K>, Iterator<K> {
        public Keys(CollectionsMapObjectInt<K> map) {
            super(map);
        }

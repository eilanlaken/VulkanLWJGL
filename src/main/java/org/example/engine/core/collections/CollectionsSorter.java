...
public class CollectionsSorter {
    ...
    private static CollectionsSorter instance;
    private CollectionsSorterArray arraySorter;
    private CollectionsSorterArrayComparable arraySorterComparable;
    ...
    public <T extends Comparable> void sort(CollectionsArray<T> a) {
        ...
        this.arraySorterComparable.doSort(a.items, 0, a.size);
    }
    ...
    public <T> void sort(CollectionsArray<T> a, Comparator<? super T> c) {
        ...
        this.arraySorter.doSort(a.items, c, 0, a.size);
    }
    ...
    public <T> void sort(T[] a, Comparator<? super T> c) {
        ...
        this.arraySorter.doSort(a, c, 0, a.length);
    }
    ...
    public <T> void sort(T[] a, Comparator<? super T> c, int fromIndex, int toIndex) {
        ...
        this.arraySorter.doSort(a, c, fromIndex, toIndex);
    }

    public static CollectionsSorter instance() {
        if (instance == null) {
            instance = new CollectionsSorter();
        }

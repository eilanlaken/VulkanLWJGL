...
public class CollectionsArrayInt {

    public int[] items;
    public int size;
    public boolean ordered;

    public CollectionsArrayInt() {
        this(true, 16);
    }

    public CollectionsArrayInt(int capacity) {
        this(true, capacity);
    }

    public CollectionsArrayInt(boolean ordered, int capacity) {
    ...
    public CollectionsArrayInt pack() {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CollectionsArrayInt)) return false;
        CollectionsArrayInt array = (CollectionsArrayInt) object;

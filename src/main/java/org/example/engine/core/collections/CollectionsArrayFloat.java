...
public class CollectionsArrayFloat {
    ...
    public CollectionsArrayFloat() {
        this(true, 16);
    }

    /** Creates an ordered array with the specified capacity. */
    public CollectionsArrayFloat(int capacity) {
        this(true, capacity);
    }
    ...
    public CollectionsArrayFloat(boolean ordered, int capacity) {
     ...
     * grown. */
    public CollectionsArrayFloat(CollectionsArrayFloat array) {
    ...
    public CollectionsArrayFloat(float[] array) {
     ...
     * @param ordered If false, methods that remove elements may change the order of other elements in the array, which avoids a
     *           memory copy. */
    public CollectionsArrayFloat(boolean ordered, float[] array, int startIndex, int count) {
        this(ordered, count);
        size = count;
    ...
    public void addAll (CollectionsArrayFloat array) {
        addAll(array.items, 0, array.size);
    }

    public void addAll (CollectionsArrayFloat array, int offset, int length) {

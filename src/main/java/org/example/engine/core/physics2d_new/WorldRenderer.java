            ...
            for (Body body : bodies) {
                ...
                for (BodyCollider collider : colliders) {
                    ...
                    if (collider instanceof BodyColliderCircle) {
                        ...
                        float tint = body.motionType == BodyMotionType.STATIC ? TINT_STATIC : body.motionType == BodyMotionType.KINEMATIC ? TINT_KINEMATIC : TINT_NEWTONIAN;
...
//                        float tint = body.motionType == org.example.engine.core.physics2d.Body.MotionType.STATIC ? TINT_STATIC : body.motionType == org.example.engine.core.physics2d.Body.MotionType.KINEMATIC ? TINT_KINEMATIC : TINT_NEWTONIAN;
//                        float angleRad = body.aRad;
...
//                        float tint = body.motionType == org.example.engine.core.physics2d.Body.MotionType.STATIC ? TINT_STATIC : body.motionType == Body.MotionType.KINEMATIC ? TINT_KINEMATIC : TINT_NEWTONIAN;

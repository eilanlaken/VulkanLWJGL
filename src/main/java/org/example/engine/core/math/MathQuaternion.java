...
public class MathQuaternion {
    ...
    private static MathQuaternion tmp2 = new MathQuaternion(0, 0, 0, 0);
    ...
    public MathQuaternion(float x, float y, float z, float w) {
        this.set(x, y, z, w);
    }
    ...
    public MathQuaternion(MathQuaternion quaternion) {
        this.set(quaternion);
    }
    ...
    public MathQuaternion(MathVector3 axis, float angle) {
        this.set(axis, angle);
    }
    ...
    public MathQuaternion set(float x, float y, float z, float w) {
        this.x = x;
        this.y = y;
        this.z = z;
        this.w = w;
     ...
     * @return This quaternion for chaining. */
    public MathQuaternion set(MathQuaternion quaternion) {
     ...
     * @param angle The angle in degrees
     * @return This quaternion for chaining. */
    public MathQuaternion set(MathVector3 axis, float angle) {
        return setFromAxis(axis.x, axis.y, axis.z, angle);
    }

    /** @return a copy of this quaternion */
    public MathQuaternion cpy() {
    ...
    public MathQuaternion setEulerAngles(float yaw, float pitch, float roll) {
     ...
     * @return this quaternion */
    public MathQuaternion setEulerAnglesRad(float pitch, float yaw, float roll) {
     ...
     *
     * @return This quaternion for chaining */
    public MathQuaternion conjugate() {
        x = -x;
        y = -y;
        z = -z;
        return this;
    ...
    public MathVector3 transform(MathVector3 v) {
        tmp2.set(this);
        tmp2.conjugate();
     ...
     * @return This quaternion for chaining */
    public MathQuaternion mul(final MathQuaternion other) {
     ...
     * @return This quaternion for chaining */
    public MathQuaternion mul(final float x, final float y, final float z, final float w) {
     ...
     * @param other Quaternion to multiply with
     * @return This quaternion for chaining */
    public MathQuaternion mulLeft(MathQuaternion other) {
     ...
     * @param w the w component of the other quaternion to multiply with
     * @return This quaternion for chaining */
    public MathQuaternion mulLeft(final float x, final float y, final float z, final float w) {
    ...
    public MathQuaternion add(MathQuaternion quaternion) {
        this.x += quaternion.x;
        this.y += quaternion.y;
        this.z += quaternion.z;
        this.w += quaternion.w;
    ...
    /** Add the x,y,z,w components of the passed in quaternion to the ones of this quaternion */
    public MathQuaternion add(float qx, float qy, float qz, float qw) {
        this.x += qx;
        this.y += qy;
        this.z += qz;
        this.w += qw;
...
// method
    ...
    public void toMatrix(final float[] matrix) {
        ...
        matrix[MathMatrix4.M00] = 1 - 2 * (yy + zz);
        matrix[MathMatrix4.M01] = 2 * (xy - zw);
        matrix[MathMatrix4.M02] = 2 * (xz + yw);
        matrix[MathMatrix4.M03] = 0;
        matrix[MathMatrix4.M10] = 2 * (xy + zw);
        matrix[MathMatrix4.M11] = 1 - 2 * (xx + zz);
        matrix[MathMatrix4.M12] = 2 * (yz - xw);
        matrix[MathMatrix4.M13] = 0;
        matrix[MathMatrix4.M20] = 2 * (xz - yw);
        matrix[MathMatrix4.M21] = 2 * (yz + xw);
        matrix[MathMatrix4.M22] = 1 - 2 * (xx + yy);
        matrix[MathMatrix4.M23] = 0;
        matrix[MathMatrix4.M30] = 0;
        matrix[MathMatrix4.M31] = 0;
        matrix[MathMatrix4.M32] = 0;
        matrix[MathMatrix4.M33] = 1;
    }

    /** Sets the quaternion to an identity Quaternion
     * @return this quaternion for chaining */
    public MathQuaternion idt () {
...
//    }
     ...
     * @return This quaternion for chaining. */
    public MathQuaternion setFromAxis(final MathVector3 axis, final float degrees) {
     ...
     * @return This quaternion for chaining. */
    public MathQuaternion setFromAxisRad(final MathVector3 axis, final float radians) {
     ...
     * @param degrees The angle in degrees
     * @return This quaternion for chaining. */
    public MathQuaternion setFromAxis(final float x, final float y, final float z, final float degrees) {
     ...
     * @param radians The angle in radians
     * @return This quaternion for chaining. */
    public MathQuaternion setFromAxisRad(final float x, final float y, final float z, final float radians) {
        float d = MathVector3.len(x, y, z);
        if (d == 0f) return idt();
        d = 1f / d;
    ...
    public MathQuaternion setFromMatrix(boolean normalizeAxes, MathMatrix4 matrix) {
        return setFromAxes(normalizeAxes, matrix.val[MathMatrix4.M00], matrix.val[MathMatrix4.M01], matrix.val[MathMatrix4.M02],
                matrix.val[MathMatrix4.M10], matrix.val[MathMatrix4.M11], matrix.val[MathMatrix4.M12], matrix.val[MathMatrix4.M20],
                matrix.val[MathMatrix4.M21], matrix.val[MathMatrix4.M22]);
    }

    /** Sets the Quaternion from the given rotation matrix, which must not contain scaling. */
    public MathQuaternion setFromMatrix(MathMatrix4 matrix) {
...
//    }
    ...
    public MathQuaternion setFromAxes(float xx, float xy, float xz, float yx, float yy, float yz, float zx, float zy, float zz) {
     ...
     * @param zy z-axis y-coordinate
     * @param zz z-axis z-coordinate */
    public MathQuaternion setFromAxes(boolean normalizeAxes, float xx, float xy, float xz, float yx, float yy, float yz, float zx,
                                      float zy, float zz) {
        if (normalizeAxes) {
            final float lx = 1f / MathVector3.len(xx, xy, xz);
            final float ly = 1f / MathVector3.len(yx, yy, yz);
            final float lz = 1f / MathVector3.len(zx, zy, zz);
            xx *= lx;
            xy *= lx;
            xz *= lx;
            yx *= ly;
     ...
     * @return this quaternion for chaining */
    public MathQuaternion slerp(MathQuaternion end, float alpha) {
     ...
     * @return This quaternion for chaining */
    public MathQuaternion slerp(MathQuaternion[] q) {
     ...
     * @return This quaternion for chaining */
    public MathQuaternion slerp(MathQuaternion[] q, float[] w) {
     ...
     * @return This quaternion for chaining */
    public MathQuaternion exp(float alpha) {
...
// value
    ...
    public float dot(final MathQuaternion other) {
     ...
     * @return this quaternion for chaining. */
    public MathQuaternion mul(float scalar) {
        this.x *= scalar;
        this.y *= scalar;
        this.z *= scalar;
        this.w *= scalar;
    ...
    public float getAxisAngle(MathVector3 axis) {
     ...
     * @see <a href="http://en.wikipedia.org/wiki/Axis%E2%80%93angle_representation">wikipedia</a>
     * @see <a href="http://www.euclideanspace.com/maths/geometry/rotations/conversions/quaternionToAngle">calculation</a> */
    public float getAxisAngleRad(MathVector3 axis) {
     ...
     * {@link #getAxisAngleRad(MathVector3)} to get both the axis and the angle of this rotation. Use
     * {@link #getAngleAroundRad(MathVector3)} to get the angle around a specific axis.
     * @return the angle in radians of the rotation */
    public float getAngleRad() {
        return (float)(2.0 * Math.acos((this.w > 1) ? (this.w / len()) : this.w));
    }

    /** Get the angle in degrees of the rotation this quaternion represents. Use {@link #getAxisAngle(MathVector3)} to get both the
     * axis and the angle of this rotation. Use {@link #getAngleAround(MathVector3)} to get the angle around a specific axis.
    ...
    public void getSwingTwist(final float axisX, final float axisY, final float axisZ, final MathQuaternion swing,
                               final MathQuaternion twist) {
     ...
     * @param twist will receive the twist rotation: the rotation around the specified axis
     * @see <a href="http://www.euclideanspace.com/maths/geometry/rotations/for/decomposition">calculation</a> */
    public void getSwingTwist(final MathVector3 axis, final MathQuaternion swing, final MathQuaternion twist) {
     ...
     * @return the angle in radians of the rotation around the specified axis */
    public float getAngleAroundRad(final MathVector3 axis) {
     ...
     * @param axis the normalized axis for which to get the angle
     * @return the angle in degrees of the rotation around the specified axis */
    public float getAngleAround(final MathVector3 axis) {

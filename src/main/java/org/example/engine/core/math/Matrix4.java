...
public class Matrix4 {
     ...
     * @param scale The scale
     * @return This matrix for chaining */
    public Matrix4 setToTranslationRotationScale(Vector3 position, Quaternion orientation, Vector3 scale) {
    ...
    public Matrix4 setToTranslationRotationScale(Vector3 xAxis, Vector3 yAxis, Vector3 zAxis, Vector3 pos) {
        val[M00] = xAxis.x;
        val[M01] = xAxis.y;
        val[M02] = xAxis.z;
        val[M10] = yAxis.x;
...
//    }
    ...
    */
    public static void mulVectors(Matrix4 m, Vector3[] vector3s) {
     ...
     * @param vector3s the vectors
     * */
    public static void prj (Matrix4 m, Vector3[] vector3s) {
        for (int i = 0; i < vector3s.length; i++) {
            vector3s[i].prj(m);
        }
    }
     ...
     * @param vector3s the vectors
     * */
    public static void rot (Matrix4 m, Vector3[] vector3s) {
        for (int i = 0; i < vector3s.length; i++) {
            vector3s[i].rot(m);
        }
    }

...
public class MathMatrix4 {
    ...
    static final MathQuaternion quat = new MathQuaternion();
    static final MathQuaternion quat2 = new MathQuaternion();
    static final MathVector3 l_vez = new MathVector3();
    static final MathVector3 l_vex = new MathVector3();
    static final MathVector3 l_vey = new MathVector3();
    static final MathVector3 tmpVec = new MathVector3();
    static final MathMatrix4 tmpMat = new MathMatrix4();
    static final MathVector3 right = new MathVector3();
    static final MathVector3 tmpForward = new MathVector3();
    static final MathVector3 tmpUp = new MathVector3();
    ...
    public MathMatrix4(MathMatrix4 matrix) {
        set(matrix);
    }
     ...
     *           modified) */
    public MathMatrix4(float[] values) {
        set(values);
    }

    /** Constructs a rotation matrix from the given {@link MathQuaternion}.
     * @param quaternion The quaternion to be copied. (The quaternion is not modified) */
    public MathMatrix4(MathQuaternion quaternion) {
    ...
    public MathMatrix4(MathVector3 position, MathQuaternion rotation, MathVector3 scale) {
    ...
    public MathMatrix4 set(MathMatrix4 matrix) {
     ...
     * @return This matrix for the purpose of chaining methods together. */
    public MathMatrix4 set(float[] values) {
     ...
     * @return This matrix for the purpose of chaining methods together. */
    public MathMatrix4 setToTranslationRotationScale(MathQuaternion quaternion) {
     ...
     * @return This matrix for the purpose of chaining methods together. */
    public MathMatrix4 set(float quaternionX, float quaternionY, float quaternionZ, float quaternionW) {
    ...
    public MathMatrix4 set(MathVector3 position, MathQuaternion orientation) {
     ...
     * @param quaternionW The W component of the quaternion that is to be used to set this matrix.
     * @return This matrix for the purpose of chaining methods together. */
    public MathMatrix4 set(float translationX, float translationY, float translationZ, float quaternionX, float quaternionY,
     ...
     * @param scale The scale
     * @return This matrix for chaining */
    public MathMatrix4 setToTranslationRotationScale(MathVector3 position, MathQuaternion orientation, MathVector3 scale) {
     ...
     * @return This matrix for the purpose of chaining methods together. */
    public MathMatrix4 setToTranslationRotationScale(float translationX, float translationY, float translationZ, float quaternionX, float quaternionY,
    ...
    public MathMatrix4 setToTranslationRotationScale(MathVector3 xAxis, MathVector3 yAxis, MathVector3 zAxis, MathVector3 pos) {
        val[M00] = xAxis.x;
        val[M01] = xAxis.y;
        val[M02] = xAxis.z;
        val[M10] = yAxis.x;
     ...
     * @return This matrix for the purpose of chaining methods together. */
    public MathMatrix4 trn(float x, float y, float z) {
        val[M03] += x;
        val[M13] += y;
        val[M23] += z;
        return this;
    ...
    public MathMatrix4 mul(MathMatrix4 matrix) {
        mul(val, matrix.val);
        return this;
    }
     ...
     * @param matrix The other matrix to multiply by.
     * @return This matrix for the purpose of chaining operations together. */
    public MathMatrix4 mulLeft(MathMatrix4 matrix) {
        tmpMat.set(matrix);
        mul(tmpMat.val, val);
        return set(tmpMat);
    }
     ...
     * @return This matrix for the purpose of chaining methods together. */
    public MathMatrix4 setToPerspectiveProjection(float near, float far, float verticalFov, float aspectRatio) {
        idt();
     ...
     * @param far The far plane
     * @return This matrix for the purpose of chaining methods together. */
    public MathMatrix4 setToPerspectiveProjection(float left, float right, float bottom, float top, float near, float far) {
     ...
     * @return This matrix for the purpose of chaining methods together. */
    public MathMatrix4 setToOrtho2D(float x, float y, float width, float height) {
     ...
     * @param far The far plane
     * @return This matrix for the purpose of chaining methods together. */
    public MathMatrix4 setToOrtho2D(float x, float y, float width, float height, float near, float far) {
     ...
     * @return This matrix for the purpose of chaining methods together. */
    public MathMatrix4 setToOrthographicProjection(float left, float right, float bottom, float top, float near, float far) {
     ...
     * @return This matrix for the purpose of chaining methods together. */
    public MathMatrix4 setTranslation(MathVector3 vector) {
        val[M03] = vector.x;
        val[M13] = vector.y;
        val[M23] = vector.z;
        return this;
     ...
     * @return This matrix for the purpose of chaining methods together. */
    public MathMatrix4 setTranslation(float x, float y, float z) {
        val[M03] = x;
        val[M13] = y;
        val[M23] = z;
        return this;
     ...
     * @param vector The translation vector
     * @return This matrix for the purpose of chaining methods together. */
    public MathMatrix4 setToTranslation(MathVector3 vector) {
        idt();
        val[M03] = vector.x;
        val[M13] = vector.y;
        val[M23] = vector.z;
     ...
     * @param z The z-component of the translation vector.
     * @return This matrix for the purpose of chaining methods together. */
    public MathMatrix4 setToTranslation(float x, float y, float z) {
        idt();
        val[M03] = x;
        val[M13] = y;
        val[M23] = z;
     ...
     * @return This matrix for the purpose of chaining methods together. */
    public MathMatrix4 setToTranslationAndScaling(MathVector3 translation, MathVector3 scaling) {
        idt();
     ...
     * @return This matrix for the purpose of chaining methods together. */
    public MathMatrix4 setToTranslationAndScaling(float translationX, float translationY, float translationZ, float scalingX,
     ...
     * @return This matrix for the purpose of chaining methods together. */
    public MathMatrix4 setToRotation(MathVector3 axis, float degrees) {
        if (degrees == 0) {
            idt();
            return this;
        }
     ...
     * @return This matrix for the purpose of chaining methods together. */
    public MathMatrix4 setToRotationRad(MathVector3 axis, float radians) {
        if (radians == 0) {
            idt();
            return this;
        }
     ...
     * @param degrees The angle in degrees
     * @return This matrix for the purpose of chaining methods together. */
    public MathMatrix4 setToRotation(float axisX, float axisY, float axisZ, float degrees) {
        if (degrees == 0) {
            idt();
            return this;
        }
     ...
     * @param radians The angle in radians
     * @return This matrix for the purpose of chaining methods together. */
    public MathMatrix4 setToRotationRad(float axisX, float axisY, float axisZ, float radians) {
        if (radians == 0) {
            idt();
            return this;
        }
     ...
     * @return This matrix for the purpose of chaining methods together */
    public MathMatrix4 setToRotation(final MathVector3 v1, final MathVector3 v2) {
     ...
     * @return This matrix for the purpose of chaining methods together */
    public MathMatrix4 setToRotation(final float x1, final float y1, final float z1, final float x2, final float y2, final float z2) {
     ...
     * @return This matrix */
    public MathMatrix4 setFromEulerAngles(float yaw, float pitch, float roll) {
     ...
     * @return This matrix */
    public MathMatrix4 setFromEulerAnglesRad(float yaw, float pitch, float roll) {
     ...
     * @return This matrix for chaining. */
    public MathMatrix4 setToScaling(MathVector3 vector) {
        idt();
        val[M00] = vector.x;
        val[M11] = vector.y;
        val[M22] = vector.z;
     ...
     * @return This matrix for chaining. */
    public MathMatrix4 setToScaling(float x, float y, float z) {
        idt();
        val[M00] = x;
        val[M11] = y;
        val[M22] = z;
     ...
     * @return This matrix for the purpose of chaining methods together. */
    public MathMatrix4 setToLookAt(MathVector3 direction, MathVector3 up) {
     ...
     * @param up the up vector
     * @return This matrix */
    public MathMatrix4 setToLookAt(MathVector3 position, MathVector3 target, MathVector3 up) {
    ...
    public MathMatrix4 setToWorld(MathVector3 position, MathVector3 forward, MathVector3 up) {
     ...
     * @return This matrix for the purpose of chaining methods together. */
    public MathMatrix4 lerp(MathMatrix4 matrix, float alpha) {
        for (int i = 0; i < 16; i++)
            val[i] = val[i] * (1 - alpha) + matrix.val[i] * alpha;
        return this;
    }

    public MathMatrix4 sclXYZ(MathVector3 scale) {
        val[M00] *= scale.x;
        val[M11] *= scale.y;
        val[M22] *= scale.z;
        return this;
    ...
    public MathMatrix4 sclXYZ(float x, float y, float z) {
        val[M00] *= x;
        val[M11] *= y;
        val[M22] *= z;
        return this;
    ...
    public MathMatrix4 sclXYZ(float scale) {
        val[M00] *= scale;
        val[M11] *= scale;
        val[M22] *= scale;
        return this;
    ...
    // TODO: careful
    public MathMatrix4 stretch(float scale) {
        val[M00] *= scale;
        val[M10] *= scale;
        val[M20] *= scale;
        return this;
    ...
    public MathMatrix4 elongate(float scale) {
        val[M01] *= scale;
        val[M11] *= scale;
        val[M21] *= scale;
        return this;
    ...
    public MathMatrix4 lengthen(float scale) {
        val[M02] *= scale;
        val[M12] *= scale;
        val[M22] *= scale;
        return this;
    ...
    public MathVector3 getTranslation(MathVector3 position) {
        position.x = val[M03];
        position.y = val[M13];
        position.z = val[M23];
        return position;
     ...
     * @param rotation The {@link MathQuaternion} to receive the rotation
     * @param normalizeAxes True to normalize the axes, necessary when the matrix might also include scaling.
     * @return The provided {@link MathQuaternion} for chaining. */
    public MathQuaternion getRotation(MathQuaternion rotation, boolean normalizeAxes) {
        return rotation.setFromMatrix(normalizeAxes, this);
    }

    // TODO: remove
    public MathMatrix4 scaleSelf_test(float scale) {
        MathQuaternion r = getRotation(new MathQuaternion());
        MathMatrix4 rot = new MathMatrix4(r);
        MathMatrix4 rotInv = new MathMatrix4(r);
        rotInv.inv();
        MathMatrix4 s = new MathMatrix4();
        s.sclXYZ(scale,1,1);
        MathMatrix4 m = new MathMatrix4(rotInv);
        m.mul(s);
        m.mul(rot);
        return this.mul(m);
    }
     ...
     * @param rotation The {@link MathQuaternion} to receive the rotation
     * @return The provided {@link MathQuaternion} for chaining. */
    public MathQuaternion getRotation(MathQuaternion rotation) {
    ...
    public MathVector3 getScale(MathVector3 scale) {
        return scale.set(getScaleX(), getScaleY(), getScaleZ());
    }

    public MathVector3 getScaleSquared(MathVector3 scale) {
    ...
    public MathMatrix4 toNormalMatrix() {
        val[M03] = 0;
        val[M13] = 0;
        val[M23] = 0;
        return inv().tra();
     ...
     * from {@link MathMatrix4#val}. The vectors array is assumed to hold 3-component vectors. Offset specifies the offset into the
     ...
     * the same as {@link MathVector3#mul(MathMatrix4)} applied to multiple vectors.
     * @param m the matrix
     * @param vector3s the vectors
    */
    public static void mulVectors(MathMatrix4 m, MathVector3[] vector3s) {
     ...
     * major matrix as you can get from {@link MathMatrix4#val}. The vectors array is assumed to hold 3-component vectors. Offset
     ...
     * vectors and must be >= 3. This is the same as {@link MathVector3#prj(MathMatrix4)} applied to multiple vectors.
     * @param m the matrix
     * @param vector3s the vectors
     * */
    public static void prj (MathMatrix4 m, MathVector3[] vector3s) {
        for (int i = 0; i < vector3s.length; i++) {
            vector3s[i].prj(m);
        }
    }
     ...
     * column major matrix as you can get from {@link MathMatrix4#val}. The vectors array is assumed to hold 3-component vectors.
     ...
     * subsequent vectors and must be >= 3. This is the same as {@link MathVector3#rot(MathMatrix4)} applied to multiple vectors.
     * @param m the matrix
     * @param vector3s the vectors
     * */
    public static void rot (MathMatrix4 m, MathVector3[] vector3s) {
        for (int i = 0; i < vector3s.length; i++) {
            vector3s[i].rot(m);
        }
    }
     ...
     * matrices as you can get from {@link MathMatrix4#val}. This is the same as {@link MathMatrix4#mul(MathMatrix4)}.
     *
     ...
     * from {@link MathMatrix4#val}. The vector array is assumed to hold a 3-component vector, with x being the first element, y being
     * the second and z being the last component. The result is stored in the vector array. This is the same as
     * {@link MathVector3#mul(MathMatrix4)}.
     ...
     * major matrix as you can get from {@link MathMatrix4#val}. The vector array is assumed to hold a 3-component vector, with x being
     * the first element, y being the second and z being the last component. The result is stored in the vector array. This is the
     * same as {@link MathVector3#prj(MathMatrix4)}.
     * @param mat the matrix
     * @param vec the vector. */
     ...
     * column major matrix as you can get from {@link MathMatrix4#val}. The vector array is assumed to hold a 3-component vector, with
     ...
     * is the same as {@link MathVector3#rot(MathMatrix4)}.
     * @param mat the matrix
     * @param vec the vector. */
     ...
     * @param translation
     * @return This matrix for the purpose of chaining methods together. */
    public MathMatrix4 translateSelfAxis(MathVector3 translation) {
    ...
    public MathMatrix4 translateSelfAxis(float x, float y, float z) {
    ...
    // TODO: see what is up
    public MathMatrix4 translateXYZAxis(float x, float y, float z) {
        val[M03] += x;
        val[M13] += y;
        val[M23] += z;
        return this;
     ...
     * @param degrees The angle in degrees.
     * @return This matrix for the purpose of chaining methods together. */
    public MathMatrix4 rotateSelfAxis(MathVector3 axis, float degrees) {
     ...
     * @param radians The angle in radians.
     * @return This matrix for the purpose of chaining methods together. */
    public MathMatrix4 rotateRad(MathVector3 axis, float radians) {
     ...
     * @param degrees The angle in degrees
     * @return This matrix for the purpose of chaining methods together. */
    public MathMatrix4 rotateSelfAxis(float axisX, float axisY, float axisZ, float degrees) {
        if (degrees == 0) return this;
     ...
     * @param radians The angle in radians
     * @return This matrix for the purpose of chaining methods together. */
    public MathMatrix4 rotateRad(float axisX, float axisY, float axisZ, float radians) {
        if (radians == 0) return this;
     ...
     * @param rotation
     * @return This matrix for the purpose of chaining methods together. */
    public MathMatrix4 rotateSelfAxis(MathQuaternion rotation) {
     ...
     * @param v2 The target vector
     * @return This matrix for the purpose of chaining methods together */
    public MathMatrix4 rotateSelfAxis(final MathVector3 v1, final MathVector3 v2) {
     ...
     * @param up up vector
     * @return This matrix for chaining */
    public MathMatrix4 rotateTowardDirection(final MathVector3 direction, final MathVector3 up) {
        l_vez.set(direction).nor();
        l_vex.set(direction).crs(up).nor();
        l_vey.set(l_vex).crs(l_vez).nor();
     ...
     * @param up the up vector
     * @return This matrix for chaining */
    public MathMatrix4 rotateTowardTarget(final MathVector3 target, final MathVector3 up) {
     ...
     * @return This matrix for the purpose of chaining methods together. */
    public MathMatrix4 scale(float scaleX, float scaleY, float scaleZ) {
        val[M00] *= scaleX;
        val[M01] *= scaleY;
        val[M02] *= scaleZ;
        val[M10] *= scaleX;
...
//    }
    ...
    public boolean equals(Object obj) {
        ...
        MathMatrix4 other = (MathMatrix4)obj;

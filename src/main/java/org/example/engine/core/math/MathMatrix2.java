...
*/
// TODO: test
public class MathMatrix2 implements MemoryPool.Reset {
    ...
    public MathMatrix2(MathMatrix2 matrix) {
        set(matrix);
    }
     ...
     *           is not modified.) */
    public MathMatrix2(float[] values) {
        this.set(values);
    }

    /** Sets this matrix to the identity matrix
     * @return This matrix for the purpose of chaining operations. */
    public MathMatrix2 idt () {
        float[] val = this.val;
        val[M00] = 1;
        val[M10] = 0;
        val[M01] = 0;
    ...
    public MathMatrix2 mul(MathMatrix2 m) {
        float[] val = this.val;
...
//    }
     ...
     * @return This matrix for the purpose of chaining operations. */
    public MathMatrix2 setToRotation (float degrees) {
     ...
     * @return This matrix for the purpose of chaining operations. */
    public MathMatrix2 setToRotationRad (float radians) {
     ...
     * @return This matrix for the purpose of chaining operations. */
    public MathMatrix2 setToScaling(float scaleX, float scaleY) {
        float[] val = this.val;
        val[M00] = scaleX;
        val[M10] = 0;
        val[M01] = 0;
     ...
     * @return This matrix for the purpose of chaining operations.
     * */
    public MathMatrix2 inv() {
        float det = det();
        if (det == 0) throw new MathException(MathMatrix2.class.getSimpleName() + " " + this + System.lineSeparator() + " not invertible. (det == 0)");
    ...
    public MathMatrix2 set(MathMatrix2 mat) {
    ...
    public MathMatrix2 set(float[] values) {

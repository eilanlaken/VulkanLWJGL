...
public class GraphicsLightSpot extends GraphicsLight {
    ...
    public GraphicsLightSpot(GraphicsColor color, float intensity, final MathVector3 position, final MathVector3 direction, float cutoffAngle, float exponent) {

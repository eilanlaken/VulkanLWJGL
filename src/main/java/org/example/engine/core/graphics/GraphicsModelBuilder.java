...
public final class GraphicsModelBuilder {

    // TODO: implement.
    public static GraphicsModelPartMesh buildMesh(float[] positions,
                                                  float[] colors,
                                                  float[] textCoords0,
                                                  float[] textCoords1,
                                                  float[] normals,
    ...
    private static int storeDataInAttributeList(final GraphicsModelVertexAttribute attribute, float[] data){
        int vbo = GL15.glGenBuffers();

...
public class GraphicsColor {
    ...
    /** @see #rgba8888ToColor(GraphicsColor, int) */
    public GraphicsColor(int rgba8888) {
    ...
    public GraphicsColor(float r, float g, float b, float a) {
        this.r = r;
        this.g = g;
        this.b = b;
        this.a = a;
     ...
     *
     * @param color the Color */
    public GraphicsColor set(GraphicsColor color) {
        this.r = color.r;
        this.g = color.g;
        this.b = color.b;
        this.a = color.a;
     ...
     * @param color the color
     * @return this color. */
    public GraphicsColor mul(GraphicsColor color) {
        this.r *= color.r;
        this.g *= color.g;
        this.b *= color.b;
        this.a *= color.a;
     ...
     * @return this color */
    public GraphicsColor mul(float value) {
        this.r *= value;
        this.g *= value;
        this.b *= value;
        this.a *= value;
     ...
     * @param color the color
     * @return this color */
    public GraphicsColor add(GraphicsColor color) {
        this.r += color.r;
        this.g += color.g;
        this.b += color.b;
        this.a += color.a;
     ...
     * @param color the color
     * @return this color */
    public GraphicsColor sub(GraphicsColor color) {
        this.r -= color.r;
        this.g -= color.g;
        this.b -= color.b;
        this.a -= color.a;
     ...
     *
     * @return this Color for chaining */
    public GraphicsColor set(float r, float g, float b, float a) {
        this.r = r;
        this.g = g;
        this.b = b;
        this.a = a;
     ...
     * @return this Color for chaining
     * @see #rgba8888ToColor(GraphicsColor, int) */
    public GraphicsColor set(int rgba) {
     ...
     *
     * @return this Color for chaining */
    public GraphicsColor add(float r, float g, float b, float a) {
        this.r += r;
        this.g += g;
        this.b += b;
        this.a += a;
     ...
     *
     * @return this Color for chaining */
    public GraphicsColor sub(float r, float g, float b, float a) {
        this.r -= r;
        this.g -= g;
        this.b -= b;
        this.a -= a;
     ...
     *
     * @return this Color for chaining */
    public GraphicsColor mul(float r, float g, float b, float a) {
        this.r *= r;
        this.g *= g;
        this.b *= b;
        this.a *= a;
     ...
     * @return This color for chaining. */
    public GraphicsColor lerp(final GraphicsColor target, final float t) {
     ...
     * @param t The interpolation coefficient
     * @return This color for chaining. */
    public GraphicsColor lerp(final float r, final float g, final float b, final float a, final float t) {
        this.r += t * (r - this.r);
        this.g += t * (g - this.g);
        this.b += t * (b - this.b);
        this.a += t * (a - this.a);
    ...
    public GraphicsColor preMultiplyAlpha() {
        r *= a;
        g *= a;
        b *= a;
        return this;
    ...
    public boolean equals(Object o) {
        ...
        GraphicsColor color = (GraphicsColor)o;
     ...
     * @see #toString() */
    public static GraphicsColor valueOf(String hex) {
        return valueOf(hex, new GraphicsColor());
    }

    /** Sets the specified color from a hex string with the format RRGGBBAA.
     * @see #toString() */
    public static GraphicsColor valueOf(String hex, GraphicsColor color) {
    ...
    public static void rgb565ToColor(GraphicsColor color, int value) {
    ...
    public static void rgba4444ToColor(GraphicsColor color, int value) {
    ...
    public static void rgb888ToColor(GraphicsColor color, int value) {
    ...
    public static void rgba8888ToColor(GraphicsColor color, int value) {
    ...
    public static void argb8888ToColor(GraphicsColor color, int value) {
     ...
     * @param color The Color to be modified. */
    public static void abgr8888ToColor(GraphicsColor color, int value) {
        color.a = ((value & 0xff000000) >>> 24) / 255f;
     ...
     * @param color The Color to be modified. */
    public static void abgr8888ToColor (GraphicsColor color, float value) {
    ...
    public GraphicsColor fromHsv(float h, float s, float v) {
        float x = (h / 60f + 6) % 6;
        int i = (int)x;
        float f = x - i;
        float p = v * (1 - s);
     ...
     * @return The modified Color for chaining. */
    public GraphicsColor fromHsv(float[] hsv) {
    ...
    public GraphicsColor cpy() {
        return new GraphicsColor(this);
    }

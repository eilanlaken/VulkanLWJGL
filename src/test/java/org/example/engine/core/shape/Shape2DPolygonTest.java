...
//        polygon_10 = new Shape2DPolygon(new float[] {});
    ...
    @Test
    void geometryCenter() {
        Assertions.assertTrue(polygon_1.geometryCenter().epsilonEquals(new Vector2(0.5f,0.5f), MathUtils.FLOAT_ROUNDING_ERROR));
    }
    ...
    void getWorldEdge() {
        ...
        Vector2 tail1 = new Vector2();
        Vector2 head1 = new Vector2();
        ...
        Vector2 tail2 = new Vector2();
        Vector2 head2 = new Vector2();
        ...
        Vector2 tail3 = new Vector2();
        Vector2 head3 = new Vector2();
        ...
        Vector2 tail4 = new Vector2();
        Vector2 head4 = new Vector2();
        ...
        Vector2 tail5 = new Vector2();
        Vector2 head5 = new Vector2();

...
class Shape2DUnionTest {
    ...
    private static Shape2DUnion shape_4;

    @BeforeEach
    public void setup() {
        shape_1 = new Shape2DUnion(new Shape2DRectangle(2,1), new Shape2DCircle(1,2,2));
        shape_2 = new Shape2DUnion();
        shape_3 = new Shape2DUnion(new Shape2DRectangle(2,1), new Shape2DCircle(1,2,2), shape_2);
        shape_4 = new Shape2DUnion(new Shape2DRectangle(2,1), new Shape2DUnion(new Shape2DCircle(1), new Shape2DCircle(1), new Shape2DUnion(new Shape2DCircle(1))));
    }
